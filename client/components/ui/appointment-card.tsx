  ...
  const taskItems = [
    {
      ...
      iconColor:
        statuses.preChart === "error"
          ? "text-extended-sienna-700"
          : "text-black",
    },
    {
      icon: FileText,
    ...
    return (
      <div className="bg-white border border-core-slate-100 rounded-lg p-4 space-y-3">
        <div className="flex justify-between items-center">
          <h3 className="font-monument font-medium text-black text-base">
            {patientName}
          </h3>
        ...
        <div className="flex justify-between items-start">
          ...
          <span className="text-neutral-gray-700 text-sm font-monument">
            {doctor}
          </span>
        </div>
      </div>
